...
### 프로젝트 개요
**ITMSG (Advanced Request & Issue Management System)**는 IT 프로젝트 관리의 전체 라이프사이클을 지원하는 통합 엔터프라이즈 시스템입니다. SR(Service Request) 요청부터 개발, 승인, 릴리즈, 장애 관리까지 전 과정을 하나의 플랫폼에서 관리할 수 있도록 설계되었습니다.
...
ITMSG 프로젝트는 엔터프라이즈급 IT 프로젝트 관리 시스템으로, 다음과 같은 특징을 가지고 있습니다:
