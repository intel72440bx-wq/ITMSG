...
### 프로젝트 개요
**ITMSG (IT Management System GCDC)**는 IT 프로젝트 관리의 전체 라이프사이클을 지원하는 통합 엔터프라이즈 시스템입니다. SR(Service Request) 요청부터 개발, 승인, 릴리즈, 장애 관리까지 전 과정을 하나의 플랫폼에서 관리할 수 있도록 설계되었습니다.
